...
import { createNewGroupMiddleware } from "../../../../../utils/contextMiddleware/chat"

export const AddUsersToGroup = ({ closeModal }: any) => {
  ...
  return (
    <div className={s.sidebarModalBody}>
      <div className={`${s.allChats} ${s.adduserstog}`}>
        ...
        <p className={s.text}>ADD USERS</p>
        ...
        <button onClick={handleCreateNewGroup} className={s.createGrpButton}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="26"
            height="26"
