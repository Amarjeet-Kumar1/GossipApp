export const CloseIcon = ({ onClick, className }: any) => {
  return (
    <span onClick={onClick} className={className} title="Close">
      <svg
...
export const SmileIcon = ({ onClick, className }: any) => {
  return (
    <span onClick={onClick} className={className} title="Emoji">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        width="24"
...
export const GifIcon = ({ onClick, className }: any) => {
  return (
    <span onClick={onClick} className={className} title="GIF">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        width="24"
...
export const StickerIcon = ({ onClick, className }: any) => {
  return (
    <span onClick={onClick} className={className} title="Sticker">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        width="24"
...
export const VideoCallIcon = ({ onClick, className, children }: any) => {
  return (
    <span onClick={onClick} className={className} title="Video">
      {children}
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="16"
...
export const DocumentIcon = ({ children, onClick, className }: any) => {
  return (
    <span onClick={onClick} className={className} title="Document">
      {children}
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="16"
...
export const CameraIcon = ({ onClick, className }: any) => {
  return (
    <span onClick={onClick} className={className} title="Camera">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="16"
        height="16"
...
export const PictureIcon = ({ onClick, className, children }: any) => {
  return (
    <span onClick={onClick} className={className} title="Photo">
      {children}
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="16"
...
export const AttachmentIcon = ({ onClick, className }: any) => {
  return (
    <span onClick={onClick} className={className} title="Attachments">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        width="24"
